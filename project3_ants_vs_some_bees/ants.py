...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        Return the bees only within [min_range, max_range].
        ...
        place = self.place
        while place != None and place.bees == []:
            place = place.entrance
        if place == None or place == beehive:
            return None
        else:
...
class ShortThrower(ThrowerAnt):
    ...
    def nearest_bee(self, beehive):
        ...
        range = 0
        while place != None and place.bees == []:
            place, range = place.entrance, range + 1
...
class LongThrower(ThrowerAnt):
    ...
    def nearest_bee(self, beehive):
        place = self.place
        range = 0
        while place != None and (place.bees == [] or range < self.min_range):
            place, range = place.entrance, range + 1
        if place == None or place == beehive:
            return None
        else:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor - amount <= 0:
            attack_amount += self.damage
        for bee in bees:
            bee.reduce_armor(attack_amount)
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        ScubaThrower.__init__(self, armor=armor)
    ...
    def action(self, colony):
        ...
        if self.is_true_queen == False:
            # Set armor to 0 if is an imposter queen
            self.reduce_armor(self.armor)
        else:
            ScubaThrower.action(self, colony)
            place = self.place.exit
            # Double damage of all bees behind
            while place != None:
                if place.ant != None:
                    double_damage_if_not_already(place.ant)
                    # Also double damage of containers
